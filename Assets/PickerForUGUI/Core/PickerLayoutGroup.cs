...
namespace Picker
{
	...
	[ExecuteInEditMode, RequireComponent (typeof(RectTransform)), AddComponentMenu("UI/Picker/PickerLayoutGroup",1001), DisallowMultipleComponent]
