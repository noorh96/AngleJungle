...
namespace Picker
{
	public class PickerEditor<PickerType,PickerItemComponent, ItemParamType, ItemListType> : Editor
		where PickerItemComponent : PickerItem 
		where ItemListType : ItemList<ItemParamType>, new()
		where PickerType : Picker<PickerItemComponent,ItemParamType,ItemListType>
	{
